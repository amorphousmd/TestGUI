...
class Ui_MainWindow(object):
    ...
    def runInference(self):
        cfg = Config.fromfile('mmdetection/configs/yolox/yolox_s_8x8_300e_coco.py')
        cfg.model.bbox_head.num_classes = 1
        checkpoint = 'training_weights/YOLOX80.pth'
        ...
        center_list = detect_center_bbox(result, self.thresholdValue)
        print('\nPixel Coordinates:\n')
        print(center_list)
        print('\nWorld Coordinates:\n')
    ...
    def runInferenceVideo(self):
        ...
        cap = cv2.VideoCapture('test_videos/hnn_video_025.mp4')
        cap.set(3, 1080)
        cap.set(4, 640)
        while True:
